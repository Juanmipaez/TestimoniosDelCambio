const testimonios = [
  ...
  },
  {
    ...
    cita: "A veces la rabia se convierte en receta para la libertad."
  },
  {
    nombre: "Yule May",
    ...
    cita: "Ser juzgada por sobrevivir me enseñó que la justicia no siempre es ciega, a veces solo es blanca."
  },
  {
    nombre: "Louvenia",
    ...
    cita: "El miedo encorva, pero la verdad endereza la espalda."
  },
  {
    nombre: "Rachel",
    ...
    cita: "Lo que llaman costumbre, yo lo llamo humillación disfrazada."
  },
  {
    nombre: "Esther",
    ...
    cita: "Si somos lo que callamos, yo ya no quiero ser sombra."
  },
  {
    nombre: "Dorothy",
    ...
    cita: "Ser honesta no bastaba si no era blanca."
  },
  {
    nombre: "Mae",
    ...
    cita: "Una madre con voz fuerte cría hijos que no se callan."
  },
  {
    nombre: "Carla",
    ...
    cita: "Nos exigían respeto sin dignidad, silencio sin justicia."
  },
  {
    nombre: "Lula",
    ...
    cita: "No somos herederas del miedo, sino sembradoras de memoria."
  },
  {
    nombre: "Bernice",
    ...
    cita: "Decir que te quieren mientras te excluyen no es amor, es abuso elegante."
  },
  {
    nombre: "Anónimo",
    ...
    cita: "No tener nombre es la primera forma de ser borrada."
  },
  {
    nombre: "Tu Voz",
    ...
    esFormulario: true,
    cita: "Lo que hoy digas, puede ser la semilla del valor de alguien más mañana."
  }
];
